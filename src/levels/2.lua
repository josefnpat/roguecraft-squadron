...
level.intro = function(self)
  ...
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","Well, that’s just dandy. I guess I better use some of those materials I processed to make a [Battlestar] or two, and get rid of them.")
