...
level.intro = function(self)
  ...
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","Looks like they’re catching on. I’m glad there are some more [Asteroids] in this system to take advantage of.")
