...
level.intro = function(self)
  ...
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","What? I thought we were only going to be under for a few months. This wasn’t supposed to happen at all.")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Adjutant","Invalid query. Try again?")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","What happened? Why have I been in stasis for over one hundred years?")
  ...
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","Adjutant, why aren’t we at our destination?")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Adjutant","Destination no longer exists.")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","Wasn’t our destination a planet?")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Adjutant","Correct.")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","Well, that’s not good.")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Adjutant","Correct.")
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","How many jumps away is earth?")
  ...
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Commander","Suggestions?")
  ...
  tvn:addFrame(nil,nil,"[TIP]","Select your ship with the left mouse button. Right mouse click to move selected ships. Use the icons in the upper right to perform actions. Move your mouse to the edge of the screen, or left click on the minimap to move your camera.")
  return tvn
end
