...
level.intro = function(self)
  ...
  tvn:addFrame(vn.adj.default,vn.adj.overlay,"Adjutant","Security protocol dictates that persons in statsis should be kept in stasis until either the destination has been reached, or the ship reaches problematic thresholds.",vn_audio.adj.line3)
